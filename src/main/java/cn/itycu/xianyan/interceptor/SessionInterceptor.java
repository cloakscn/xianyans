package cn.itycu.xianyan.interceptor;

import cn.itycu.xianyan.mapper.UserMapper;
import cn.itycu.xianyan.modle.User;
import cn.itycu.xianyan.modle.UserExample;
            ...
            for (Cookie cookie : cookies) {
                if (cookie.getName().equals("token")) {
                    ...
                    if (users.size() != 0) {
                        ...
                        Long commentCount = questionService.commentCount(users.get(0).getId());
                        request.getSession().setAttribute("commentCount", commentCount);
